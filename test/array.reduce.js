...
metatests.test('reduce with initial and array', test => {
  const arr = [1, 2, 3, 4, 5];
  const initial = 10;
...
metatests.test('reduce empty items with initial', test => {
  const arr = [];
  const initial = 10;
...
metatests.test('reduce empty items without initial', test => {
  const arr = [];
